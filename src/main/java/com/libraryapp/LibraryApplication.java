...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("test"), "nandini.com", "Nandini", "N", "XYZ street", "0611433823", "Bangalore");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("Librarian", pwEncoder.encode("test"), "madhura@gmail.com", "Madhura", "C", "Electronic City", "0987054875", "Bangalore");
